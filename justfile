compile +FLAGS="":
    ...
    -
    clang example/triangle.c -fcolor-diagnostics -I. -DPLATFORM_SDL -I$SDL_INCLUDE -L$SDL_LIB -Wl,-rpath -Wl,$SDL_LIB -lSDL2 -lm -Wall -Wextra -std=c99 {{FLAGS}} -o ./bin/triangle
